...
class ShortsScheduler:
    ...
    def run_scheduler_daemon(self):
        ...
        Drip-feeds clips to achieve up to 50 uploads per day.
        """
        console.rule("[bold green]YouTube Shorts Publishing Daemon (50 Clips/Day)")
        ...
        while True:
            try:
                ...
                if today_count >= self.target_daily:
                    console.print("[green]Daily target of 50 uploads reached! Sleeping until midnight...[/green]")
                    time.sleep(3600)
                    continue
                ...
                console.print(f"\n[bold magenta]Publishing Short #{today_count + 1}:[/bold magenta] {title}")
